...
return [
    ...
    */
    ...
    'dashboard' => [
        ...
        'widgets' => [
            \App\Http\Controllers\Voyager\Dimmers\ApplicationDimmer::class,
            \App\Http\Controllers\Voyager\Dimmers\DoctorDimmer::class,
            \App\Http\Controllers\Voyager\Dimmers\SpecialitiesDimmer::class,
            \App\Http\Controllers\Voyager\Dimmers\MethodicDimmer::class,
            \App\Http\Controllers\Voyager\Dimmers\CheckupDimmer::class,
            \App\Http\Controllers\Voyager\Dimmers\AnalisDimmer::class,
            \App\Http\Controllers\Voyager\Dimmers\ResearchDimmer::class,
            \App\Http\Controllers\Voyager\Dimmers\ServicesDimmer::class,
            \App\Http\Controllers\Voyager\Dimmers\SalesDimmer::class,
        ],
