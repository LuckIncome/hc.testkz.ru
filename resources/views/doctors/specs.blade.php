...
@section('content')
    <div class="container-hc">
        <div class="bread">
            @include('partials.breadcrumbs',['title'=>$page->title,'titleLink'=> route('doctors.index'),'subtitle'=> $speciality->title])
        </div>
        <div class="title-main">
            <img src="/img/icons/doctor-links-icon.svg" alt="doc">
            <h3>{{$speciality->title}}</h3>
        </div>
        <section class="docs-inner-page">
            <div class="docs-inner-page__content">
                ...
                <div class="docs-inner-page__docs">
