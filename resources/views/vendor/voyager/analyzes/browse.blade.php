...
@section('page_header')
    ...
    <div class="container-fluid">
        ...
        @can('add', app($dataType->model_name))
            <a href="{{ route('voyager.'.$dataType->slug.'.create') }}" id="addProduct" class="btn btn-success btn-add-new">
                <i class="voyager-plus"></i> <span>{{ __('voyager::generic.add_new') }}</span>
            </a>
        @endcan
        <form action="{{ route('analyzes.import') }}" id="importForm" method="POST" enctype="multipart/form-data"
